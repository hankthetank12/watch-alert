...
class CollectorsCornerNYScraper(BaseScraper):
    key = "collectorscornerny"
    name = "Collectors Corner NY"
    base_url = "https://www.collectorscornerny.com/collections/inventory"
    ...
    def _parse(self, html: str) -> dict:
        ...
        for a_tag in soup.find_all("a", href=True):
            ...
            full_url = urljoin("https://www.collectorscornerny.com", href)
